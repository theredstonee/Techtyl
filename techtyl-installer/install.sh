...
while [ "$done" == false ]; do
  options=(
    "Install the Techtyl panel"
    "Install Techtyl Wings"
    "Install both [0] and [1] on the same machine (wings script runs after panel)"

    "Install panel with development version of the script (may be unstable!)"
    "Install Wings with development version of the script (may be unstable!)"
    "Install both [3] and [4] on the same machine (wings script runs after panel)"
    "Uninstall panel or wings with development version of the script"
  )
