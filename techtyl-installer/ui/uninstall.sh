...
main() {
  ...
  if [ -d "/var/www/pterodactyl" ]; then
    output "Techtyl Panel installation has been detected."
  ...
  if [ -d "/etc/pterodactyl" ]; then
    output "Techtyl Wings installation has been detected."
...
goodbye() {
  print_brake 62
  [ "$RM_PANEL" == true ] && output "Techtyl Panel uninstallation completed"
  [ "$RM_WINGS" == true ] && output "Techtyl Wings uninstallation completed"
